  ...
  public render(): React.ReactNode {
    return <Container>
      <HttpStatusHead>
        ...
        {L.get(L.locale)(`error-${this.props.statusCode}`)}
      </HttpStatusHead>
      <HttpStatusDescription>{L.render(L.locale)(`error-${this.props.statusCode}-d`)}</HttpStatusDescription>
      {this.props.needToReturn && <ReturnHome className="button mobile" onClick={() => cutaway('/')} data-for="tooltip" data-tip="return-t">{L.render(L.locale)("return")}</ReturnHome>}
    </Container>
  }
}
